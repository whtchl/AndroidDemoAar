...
public class PhotoPicker {
  ...
  public final static String EXTRA_COMPRESS = "compress";
  ...
  public static class PhotoPickerBuilder {
     ...
     *
     * @param context    Activity to receive result
     * @param requestCode requestCode for result
     */
    public void start(@NonNull Context context, int requestCode) {
    ...
    public PhotoPickerBuilder setCompress(int  mCompress){
        mPickerOptionsBundle.putInt(EXTRA_COMPRESS, mCompress);
        return this;
    }
