...
import com.jdjz.weex.view.WXWebViewJsBridge;
...
public class WXWebJsBridge extends WXComponent {  //activity  WXWeb
    ...
    @Deprecated
    public WXWebJsBridge(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String instanceId, boolean isLazy) {
        this(instance,dom,parent,isLazy);
    }

    public WXWebJsBridge(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, boolean isLazy) {
        super(instance, dom, parent, isLazy);
        createWebView();
    }

    protected void  createWebView(){
        mWebView = new WXWebViewJsBridge(getContext());
    }
