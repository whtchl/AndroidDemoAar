...
public class CaptureActivity extends Activity implements Callback {
    ...
    public static int bar_qcode_line = 670;//bar 370; qcode 670
    public static int bar_qcode_rect = 1;//bar 2; qcode 1;
    public static Boolean scan_type;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(type){
            CaptureActivity.bar_qcode_line=670;
            CaptureActivity.bar_qcode_rect=1;
        }else{
            CaptureActivity.bar_qcode_line=320;
            CaptureActivity.bar_qcode_rect=2;
        }
        scan_type = type;
        ...
        Log.i(TAG,"" +   CaptureActivity.bar_qcode_line+"  "+CaptureActivity.bar_qcode_rect);
    ...
    protected void handleResult(String resultString) {
        if (resultString.equals("")) {
            ...
            TransScanEntity transScanEntity = new TransScanEntity();
            transScanEntity.setType(CaptureActivity.scan_type);
            transScanEntity.setResult(resultString);

            EventBus.getDefault().post(transScanEntity);
        }
        mActivity.finish();
    }
